...
suite('crypto', function () {
    ...
    test('public key encoding', function () {
        ...
        assert.equal(key.toLegacyString(), 'PICO6RrvujLQN1x5Tacbep1KAk8zzKpSThAQXBCKYFfGUYeABhJRin')
        assert.equal(
            PublicKey.from('PICO6RrvujLQN1x5Tacbep1KAk8zzKpSThAQXBCKYFfGUYeABhJRin').toString(),
    ...
    test('public key prefix', function () {
        ...
        assert.equal(
            ...
            'PICO87DUhBcZrLhyFfBVDyu1iWZJUGURqbk6CQxwv5g6iWUCy9dCUJ'
        )
        assert.equal(
    ...
    test('sign and verify', function () {
        ...
        assert.equal(
            signature.verifyMessage(
                message,
                PublicKey.from('PICO7HBX4f8UknP5NNoX8ixCx4YrA8JcPhGbuQ7Xem8gmWg1nviTqR')
            ),
            false
        )
        // r1
    ...
    test('sign and recover', function () {
        ...
        assert.equal(
            ...
            'PICO6RrvujLQN1x5Tacbep1KAk8zzKpSThAQXBCKYFfGUYeABhJRin'
        )
        assert.equal(
