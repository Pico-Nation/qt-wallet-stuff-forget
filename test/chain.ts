...
suite('chain', function () {
    ...
    test('any transaction', function () {
        ...
        const r2 = Transaction.from(tx, [{abi, contract: 'picoio.token'}])
    ...
    test('equality helpers', function () {
        ...
        const pubKey = PublicKey.from('PICO6RrvujLQN1x5Tacbep1KAk8zzKpSThAQXBCKYFfGUYeABhJRin')
        assert.equal(
    ...
    test('authority', function () {
        const auth = Authority.from({
            ...
            keys: [
                {
                    key: 'PICO6RrvujLQN1x5Tacbep1KAk8zzKpSThAQXBCKYFfGUYeABhJRin',
                    weight: 20,
                },
                {
        ...
        assert.ok(auth.hasPermission('PICO6RrvujLQN1x5Tacbep1KAk8zzKpSThAQXBCKYFfGUYeABhJRin'))
        assert.ok(
